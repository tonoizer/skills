...
3. Run relevant verification from `AGENTS.md`. Apply `repo-guardrails`: reject unrelated files, require atomic commits, and stop on secrets or conflict markers.
